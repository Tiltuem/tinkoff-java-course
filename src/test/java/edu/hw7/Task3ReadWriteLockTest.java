...
import edu.hw7.task3.PersonDBWithReadWriteLockImpl;
...
public class Task3ReadWriteLockTest {
    static Arguments[] database() {
        PersonDBWithReadWriteLockImpl database = new PersonDBWithReadWriteLockImpl();
    ...
    public void testConcurrentAddAndFind(PersonDBWithReadWriteLockImpl database) throws Throwable {
        int numThreads = 10;
    ...
    public void testDelete(PersonDBWithReadWriteLockImpl database) {
